        ...
        <table class="table table-bordered table-hover table-striped">
                ...
                <tr>
                    ...
                    <?php
                        ...
                        while ( $column != null ) {
                            ...
                            $macroQuery=$macroQuery." LEFT JOIN (SELECT a.user, COUNT(*) AS ".$column[0]." FROM users a LEFT JOIN tickets b ON a.user=b.assigned_to WHERE severity='".$column[0]."' AND status!= 'closed' GROUP BY a.user) ".$column[0]." ON a.user=".$column[0].".user";
                            //
                            $i++;
                            ?>
                            <th>
            ...
            <tbody>
                <?php
                        ...
                        $totTicketsByType="(SELECT a.user AS USER, COUNT(*) AS TOTAL FROM users a RIGHT JOIN tickets b ON a.user=b.assigned_to ".$filterByType." WHERE a.groups='".$team."' AND status!= 'closed' GROUP BY a.user) a";
